...
| **Temp Storage IOPS**                            | Number of IOPS on local storage attached to the instance (compute node).                                                                                               | Identify disk activity causing unexpected ACU scaling.                                                                    | Bulk insert spikes Temp Storage IOPS to 8000/sec.                                                       |
...
* Temp Storage IOPS refers specifically to the local temporary storage attached to the compute node, not the shared storage layer.
